...
| 6 | MDE 81.7pp (ETH) / 179.3pp (BNB); power 7.2%/6.2%; n required 180,943 / 314,103 bars (4.3.1) | `reports/mde_power.json` | `per_bar_basis.<PAIR>.{mde_per_bar, new.mde_cumulative_pp_compounded, achieved_power, n_required, years}` |
